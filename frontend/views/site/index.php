...
?>
    ...
    <div class="row_1psdiv">
        <h2>Готовые проекты домов и коттеджей по цене от 15000 рублей</h2>
        <br>
        <p>В бюро Арпланс предлагаем вам не просто красивые картинки «квадратных метров» мечты – занимаемся продажей реальных проектов домов и коттеджей по всей России.</p>
        <br>
