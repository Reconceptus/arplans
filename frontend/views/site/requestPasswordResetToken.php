...
?>
    <div class="section site-login <?= $message ? 'successful' : '' ?>">
        <div class="content content--lg mobile-wide">
            <div class="request--wrap gradient">
                <div class="content content--xs">
                    ...
                    <h2 class="subtitle align-center">Пожалуйста, введите свой email. Туда будет выслана ссылка для
                        сброса пароля</h2>
                    <div class="success-text align-center">Спасибо. Мы выслали вам ссылку для сброса пароля</div>
