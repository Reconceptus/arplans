                                            ...
                                            <tr>
                                                <td align="center" style="padding-top: 42px;">
                                                    <table width="90%" border="0" cellspacing="0" cellpadding="0" style="text-align: left;">
                                                        <tbody>
                                                        <tr>
                                                            <td style="padding-bottom: 16px; font-size: 17px; line-height: 22px;  font-family: Arial, sans-serif;  color:#000000; text-align: left;"><?= $model->fio ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="color:#000000;  font-family: Arial, sans-serif; font-size:17px; line-height: 22px;">
                                                                <p> Статус вашего заказа №<?= $model->id ?> изменен. Новый статус - <?= \modules\shop\models\Order::getStatusName($model->status) ?></p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
