                                        ...
                                        <tr>
                                            <td align="center" style="padding-top: 42px;">
                                                <table width="90%" border="0" cellspacing="0" cellpadding="0" style="text-align: left;">
                                                    <tbody>
                                                    <tr>
                                                        <td style="padding-bottom: 16px; font-size: 17px; line-height: 22px;  font-family: Arial, sans-serif;  color:#000000; text-align: left;"><?= $user->profile->fio ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="padding-bottom: 16px; font-size: 17px; line-height: 22px;  font-family: Arial, sans-serif;  color:#000000; text-align: left;">Вы были зарегистрированы как партнер на сайте <?=Yii::$app->request->getHostInfo()?></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color:#000000;  font-family: Arial, sans-serif; font-size:17px; line-height: 22px;">
                                                            <p>Ваш логин <?=$user->username ?>, пароль <?=$password?></p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color:#000000;  font-family: Arial, sans-serif; font-size:17px; line-height: 22px;">
