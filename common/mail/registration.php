                                        ...
                                        <tr>
                                            <td align="center" style="padding-top: 42px;">
                                                <table width="90%" border="0" cellspacing="0" cellpadding="0" style="text-align: left;">
                                                    <tbody>
                                                    <tr>
                                                        <td style="padding-bottom: 16px; font-size: 17px; line-height: 22px;  font-family: Arial, sans-serif;  color:#000000; text-align: left;">Успешная регистрация!</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="color:#000000;  font-family: Arial, sans-serif; font-size:17px; line-height: 22px;">Спасибо, что выбрали наш сервис готорых проектов домов. Теперь вам доступна возможность добавлять проекты в избранное и совершать покупки на сайте <a href="<?=Yii::$app->request->getHostInfo()?>">Arplans</a></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
