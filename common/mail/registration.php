    ...
    <tr>
        <td valign="top" align="center" width="600" style="width: 600px;">
            ...
            <table width="600" cellspacing="0" cellpadding="0" style="width: 100%; max-width: 600px; min-width: 320px;">
                <tr>
                    <td bgcolor="#ffffff"
                        style="border-top-style:solid; border-top-width: 3px; border-top-color: #2196f3; ">
                                        ...
                                        <tr>
                                            <td align="center" style="padding-top: 24px;">
                                                <table width="90%" cellspacing="0" cellpadding="0" border="0">
                                                    <tr>
                                                        <td align="center"
                                                            style="height: 18px; font-size: 18px; line-height: 18px;">
                                                            <a href="https://reconceptus.github.io/Arplans/dev/build/index.html"
                                                               style="color: #21202e; text-decoration: none;"
                                                               target="_blank">
                                                                <img width="170" height="45" title="ARPLANS"
                                                                     alt="ARPLANS"
                                                                     src="https://reconceptus.github.io/Arplans/dev/build/assets/images/logo.png"
                                                                     style="border:none; max-width: 170px; height: auto; max-height: 45px;">
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table width="90%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td style="color:#000000;  font-family: Arial, sans-serif; font-size:17px; line-height: 22px;">
                                                            Спасибо, что выбрали наш сервис готовых проектов домов.
                                                            Теперь Вам доступна возможность добавлять проекты в
                                                            Избранное и совершать покупки на сайте <a
                                        ...
                                        <tr>
                                            <td align="center" style="padding-bottom: 5px; padding-top: 40px;">
                                                <table width="90%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            style="font-size: 18px; line-height: 18px; padding: 10px 0; font-family: Arial, sans-serif; color:#30343f; text-align: center;">
                                                            <a href="<?= Yii::$app->request->getHostInfo() ?>"
                                                               target="_blank"
                                                               style="font-size: 18px; line-height: 18px; font-family: Arial, sans-serif; color:#2a7ec5; text-decoration: none;">arplans.ru</a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="center" style="padding-top: 10px;">
                                                <table width="90%" border="0" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td style="font-size: 17px; line-height: 17px; padding: 10px 0; font-family: Arial, sans-serif; color:#30343f; text-align: center;"><?= \modules\content\models\ContentBlock::getValue('hot_line') ?>
                                                            &nbsp; <?= \modules\content\models\ContentBlock::getValue('phone') ?>
                                                            &nbsp; <?= \modules\content\models\ContentBlock::getValue('email') ?></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
