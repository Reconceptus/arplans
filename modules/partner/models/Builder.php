...
class Builder extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['image_id', 'back_image_id', 'region_id', 'sort', 'glued_timber', 'profiled_timber', 'wooden_frame', 'lstk', 'carcass', 'combined', 'brick', 'block', 'finishing', 'santech', 'electric', 'wooden', 'stone', 'roof', 'windows', 'stretch_ceiling', 'surround_region', 'any_region', 'is_office', 'no_page', 'is_active'], 'integer'],
    ...
    public static function getFilteredQuery(array $get)
    {
        ...
        $query = self::find()->alias('p')->distinct()
            ...
            ->andWhere(['p.no_page' => self::PAGE_NEED]);
