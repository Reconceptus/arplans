        ...
        $values = [
            ['main', 'Главная', '/', 'Текст на главной', 'main_page_text', ' <p>Мы — архитектурное бюро Арпланс и мы знаем все о строительстве домов в России, за 10 лет по
                        ...
                        <p>Мы благодарны нашим клиентам за отзывы и рекомендации, вы даете нам самый мощный импульс для
                            творчества! </p>', ''],
            ['main', 'Главная', '/', 'Автор текста на главной', 'main_page_author', '<p>Петр Васильевич,</p><p>руководитель</p>', ''],
            ['main', 'Главная', '/', 'Офферта', 'main_page_offer', 'Купить готовый проект дома', ''],
            ['main', 'Главная', '/', 'Пояснение к офферте', 'main_page_offer_annotation', 'коттеджа, бани от архитектурного бюро с доставкой курьером через 3-5 дней', ''],
        ];
